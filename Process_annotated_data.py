...
df_annotation = pd.read_excel("Gallery_annotation_1006_pre_final.xlsx", header=1)
condition = df_annotation['是否已标注'] == '是'
df_filtered = df_annotation[condition]
df_crawled = pd.read_json("crawled_examples/crawled_gallery_examples_1_code_block.json", orient="records")
...
with open('crawled_examples/Annotated_gallery_examples_1_code_block.json', 'w', encoding='utf8') as f:
    f.write(out)